...
export const LEVEL_PROGRESSION: LevelFeature[] = [
  ...
  { level: 2, features: ["Residual Memory (1 slot)"] },
  { level: 3, features: ["Chaos Surge"] },
  { level: 4, features: ["ASI / Feat"] },
  { level: 5, features: ["Stabilized Form Table (d12) unlocked", "Extra Dawn Die"] },
  { level: 6, features: ["Residual Memory (2 slots)"] },
  ...
  { level: 10, features: ["Residual Memory (3 slots)"] },
  ...
  { level: 15, features: ["Residual Memory (4 slots)", "Chaos Resonance"] },
  { level: 16, features: ["ASI / Feat"] },
  { level: 17, features: ["Stabilized Form Capstones"] },
