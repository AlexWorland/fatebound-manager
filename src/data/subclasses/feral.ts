...
export const FERAL_SUBCLASSES: SubclassEntry[] = [
  ...
  },
  {
    ...
    level13Feature: {
      ...
      description: "Learn a 3rd Elemental Discipline. Disciplines that replicate spells of 2nd level or lower cost 1 fewer Ki point (minimum 1). You gain access to disciplines that replicate 4th-level spells.",
    },
    level17Feature: {
      name: "Master of Elements",
      description: "Learn one 5th-level or lower elemental spell (e.g., cone of cold, wall of stone, conjure elemental) as an Elemental Discipline, castable for 5 Ki. Existing disciplines cost 1 fewer Ki (minimum 1).",
    },
  },
  {
    ...
    level9Feature: {
      ...
      description: "When you use Flurry of Blows, you gain the benefit of the Disengage action and your movement speed increases by 10 ft for that turn. Tipsy Sway: When a creature misses you with a melee attack, spend 1 Ki as a reaction to redirect that attack to a different creature within 5 ft of you (other than the attacker).",
    },
    level13Feature: {
      name: "Drunkard's Luck + Intoxicated Frenzy",
      description: "Drunkard's Luck: Spend 2 Ki when you make an ability check, attack roll, or saving throw with disadvantage to cancel the disadvantage. Intoxicated Frenzy: When you use Flurry of Blows, make up to 3 additional attacks (each beyond the first must target a different creature).",
    },
    level17Feature: {
      name: "Intoxicated Frenzy (Mastered)",
      description: "Flurry of Blows now grants up to 5 additional attacks (total 7 unarmed strikes on the Flurry action), but each must target a different creature.",
    },
  },
  {
    id: "feral-kensei",
    ...
    level9Feature: {
      name: "Kensei Weapons + Agile Parry + Kensei's Shot",
    ...
    level13Feature: {
      ...
      description: "Deft Strike: Spend 1 Ki when you hit with a Kensei weapon to deal additional damage equal to the weapon's damage die. One with the Blade: Your Kensei weapons are considered magical. Sharpen the Blade: Bonus action, spend 1\u20133 Ki to grant your Kensei weapon a +1 to +3 bonus on attack and damage rolls until your next long rest.",
    },
    level17Feature: {
  ...
  },
  {
    ...
    level13Feature: {
      ...
      description: "Action, hurl an orb of light (150 ft range, 20-ft sphere). Creatures in the sphere make a CON save (DC 8 + prof + WIS mod) or take 2d6 radiant damage (no damage on success); spend 1\u20133 Ki to add 2d6 radiant per Ki spent.",
    },
    level17Feature: {
      name: "Sun Shield",
  ...
  },
  {
    ...
    level9Feature: {
      ...
      description: "Healing: Replace one Flurry of Blows attack with a touch that heals a creature for 1d6 + WIS modifier HP; spend 1 Ki as part of this healing to also end one disease or the poisoned condition. Harm: When you hit with an unarmed strike, spend 1 Ki to deal an additional 1d6 + WIS modifier necrotic damage; the target also cannot regain hit points until the start of your next turn.",
    },
    level13Feature: {
      name: "Physician's Touch",
      description: "Hands of Healing can also remove one of the following conditions: blinded, deafened, paralyzed, poisoned, or stunned. Hands of Harm also causes the target to have disadvantage on its next saving throw before the start of your next turn.",
    },
    level17Feature: {
  ...
  },
  {
    ...
    level9Feature: {
      ...
      description: "Bonus action, spend 1 Ki: summon spectral arms for 10 minutes. These arms give your unarmed strikes a reach of 10 ft, deal force damage using your Martial Arts die + WIS modifier (instead of STR or DEX), and count as weapons for Extra Attack. While the arms are active, you gain proficiency in Athletics and Intimidation (Expertise if already proficient).",
    },
    level13Feature: {
      name: "Visage of the Astral Self",
      description: "Spend 1 Ki (bonus action): manifest a spectral visage for 10 minutes, gaining darkvision 120 ft, advantage on Insight and Intimidation checks, and the ability to speak telepathically to any creature within 60 ft you can see (no shared language required). When your visage and arms are both active, you gain resistance to psychic damage.",
    },
    level17Feature: {
      name: "Body of the Astral Self",
      description: "When your astral arms and visage are both active, when you take damage you can use your reaction to reduce that damage by 1d10 + WIS modifier. Your Astral Self arms deal an extra 1d10 force damage on attacks.",
    },
  },
  {
    ...
    level9Feature: {
      ...
      description: "Your unarmed strikes can deal your choice of acid, cold, fire, lightning, or poison damage (chosen when you roll). You can replace one attack in the Attack action with a 20-ft cone breath weapon; creatures in the cone make a DEX save (DC 8 + prof + WIS mod) or take 2d4 damage of your chosen type (half on save). This damage increases as your Martial Arts die increases. Uses = prof bonus/long rest. Draconic Presence: Spend 1 Ki; creatures within 10 ft must succeed on a WIS save or become frightened or charmed (your choice) until the end of your next turn.",
    },
    level13Feature: {
      name: "Wings Unfurled + Aspect of the Wyrm",
      description: "Wings Unfurled: When you use Step of the Wind, you gain a flying speed equal to your walking speed until the end of your turn. Aspect of the Wyrm: Bonus action, spend 3 Ki: create a 10-ft aura for 1 minute (concentration). Choose frightened (creatures that enter the aura must succeed on a WIS save or become frightened for 1 minute) or resistance (you and your allies gain resistance to your chosen damage type while in the aura).",
    },
    level17Feature: {
      name: "Ascendant Aspect",
      description: "You gain blindsight out to 10 ft. Your breath weapon becomes a 60-ft cone dealing 4d8 damage; you can use it without spending a proficiency bonus use. While your breath weapon is available, you can use it instead of one attack in your Attack action.",
    },
  },
  {
    id: "feral-long-death",
